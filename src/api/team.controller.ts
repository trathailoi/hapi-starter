 ...
 */
  ...
  public async addTeam(request: Request, toolkit: ResponseToolkit) {
    ...
    const team = await this.teamService.save(payload);
    return toolkit.response(team);
  }
 ...
 */
  ...
  public async getTeamById(request: Request, toolkit: ResponseToolkit) {
    const item = await this.teamService.findById(request.params.id);
    if (!item) {
      throw Boom.notFound();
    }
 ...
 */
  ...
  public async deleteTeam(request: Request, toolkit: ResponseToolkit) {
    const result = await this.teamService.delete(request.params.id);
    if (!result.affected) {
      throw Boom.notFound();
    }
